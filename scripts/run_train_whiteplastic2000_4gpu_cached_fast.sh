...
CONFIG_PATH="${CONFIG_PATH:-$ROOT/configs/train_sdxl_inpaint_controlnet_dualcontrol_pretrained_canny_headlesspose_whiteplastic2000_4gpu_cached_fast_50ep.yaml}"
...
DATASET_ROOT="$ROOT/datasets/whiteplastic2000_sourceeqtarget_clothescanny_headlesspose_dualcontrol"
