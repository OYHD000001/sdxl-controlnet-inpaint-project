...
CONFIG_PATH="${CONFIG_PATH:-$ROOT/configs/train_canonical_real_to_mannequin_pose_inpaint_2000_768x1024_50ep_run44_keepblend.yaml}"
...
DATASET_ROOT="$ROOT/datasets/canonical_real_to_mannequin_pose_inpaint_2000_768x1024"
