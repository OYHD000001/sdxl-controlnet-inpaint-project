...
CONFIG_PATH="${CONFIG_PATH:-$ROOT/configs/train_run38_inpaint_dualcontrol_clothesrgb_headlesspose_image2_2000_flux_sourcecutout_768x1024_50ep.yaml}"
MAIN_PROCESS_PORT="${MAIN_PROCESS_PORT:-29538}"
...
DATASET_ROOT="$ROOT/datasets/image2_2000_flux_sourcecutout_clothesrgb_headlesspose_inpaint_dualcontrol_768x1024"
